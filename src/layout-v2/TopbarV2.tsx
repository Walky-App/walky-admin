...
import { cilBell, cilMenu, cilChevronBottom } from "@coreui/icons";
          ...
          <div className="selector-container">
            ...
            <div className="selector-group">
              <div className="selector-icon">
                <img
                  src="https://www.figma.com/api/mcp/asset/600dc5c3-2b00-42d7-9bdb-e8052c0793c5"
                  alt="School icon"
                  width="24"
                  height="24"
                />
            ...
            <div className="selector-group">
              <div className="selector-icon">
                <img
                  src="https://www.figma.com/api/mcp/asset/f7c4faac-b2d8-4149-9676-a5561ad3c275"
                  alt="Campus icon"
                  width="24"
                  height="24"
                />
