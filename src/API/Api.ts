...
> extends HttpClient<SecurityDataType> {
  api = {
    ...
    /**
     * @description Returns average time to first collaborator and average response time
     *
     * @tags Admin Analytics
    ...
    /**
     * @description Deletes an idea and sends an email notification to the owner with the reason
     *
     * @tags AdminV2
    ...
    adminV2IdeasDelete: (
      id: string,
      data: {
        /** Reason for deleting the idea (sent to owner via email) */
        reason?: string;
      },
      params: RequestParams = {},
    ) =>
    ...
    /**
     * @description Logs out all other devices by invalidating all existing tokens. Returns new tokens for the current session.
     *
     * @tags AdminV2
      ...
      this.request<
        {
          ...
          message?: string;
          /** New JWT access token for current session */
          accessToken?: string;
          /** New JWT refresh token for current session */
          refreshToken?: string;
        },
        any
      >({
      ...
      this.request<
        {
          ...
          /** Change in total students from last month (positive or negative) */
          totalStudentsFromLastMonth?: number;
          /** Students with active app access (not banned) */
     ...
     *
     * @tags AdminV2
     * @name AdminV2StudentsActivateCreate
     * @summary Activate student (reactivate deactivated user)
     * @request POST:/api/admin/v2/students/{id}/activate
     * @secure
     */
     ...
     *
     * @tags AdminV2
     * @name AdminV2MembersStatusPartialUpdate
     * @summary Activate or deactivate a member
     * @request PATCH:/api/admin/v2/members/{id}/status
     * @secure
     */
    adminV2MembersStatusPartialUpdate: (
      id: string,
      data: {
        isActive?: boolean;
      },
