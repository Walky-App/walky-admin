...
const rolePermissionsData: Record<RoleType, RoleData> = {
  "Walky Admin": {
    ...
    permissions: [
      ...
      { name: "Report & Safety:", actions: "Read, Update, Export." },
      { name: "Report History:", actions: "Read, Update, Export." },
  ...
  Moderator: {
    ...
    permissions: [
      ...
      { name: "Active Students:", actions: "None." },
      { name: "Banned Students:", actions: "None." },
      { name: "Inactive Students:", actions: "None." },
      { name: "Disengaged Students:", actions: "None." },
      { name: "Reported Content:", actions: "None." },
      ...
      { name: "Report & Safety:", actions: "Read, Update, Export." },
      { name: "Report History:", actions: "Read, Update, Export." },
      { name: "Campuses:", actions: "None." },
      { name: "Ambassadors:", actions: "None." },
      { name: "Role Management:", actions: "None." },
    ],
  },
};
