...
export default function Signup() {
  ...
  return (
    <section className="flex justify-center md:mt-20 md:pb-20 h-screen lg:items-center bg-zinc-50">
      <div className="w-full px-4 py-12 sm:px-6 sm:py-0 lg:w-1/2 lg:px-8 lg:py-16 border-2 border-zinc-950 bg-zinc-50">
        ...
        <form onSubmit={handleSignup} className="mx-auto mb-0 mt-8 max-w-md space-y-4">
          ...
          <div className="flex justify-center">
            <p className="text-sm text-zinc-500">
              ...
              <Link className="underline hover:text-green-700" href="/login">
                Login
              </Link>
            </p>
          </div>
