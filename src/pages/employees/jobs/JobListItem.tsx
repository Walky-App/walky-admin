import { BriefcaseIcon, MapPinIcon, CreditCardIcon, BookmarkIcon } from '@heroicons/react/20/solid'
...
export default function JobListItem({ job }: any) {
    ...
    return (
        ...
        <li
            ...
            {/* Job Card */}
            <div className="flex h-full flex-col items-start justify-center gap-2.5 rounded-lg border border-zinc-100 bg-white pt-5">
                {/* <div className="flex flex-col items-start justify-center "> */}
                {/* Job Skills */}
                {/* <div className="flex flex-col items-start justify-start gap-4"> */}
                <div className="flex basis-1/3 flex-wrap gap-2 px-5">
                    {job.skills.map((skill: string) => (
                        <Badge key={skill} color="gray" size="sm">
                            <p className="text-xs font-normal text-stone-500">{skill}</p>
                        </Badge>
                        // <div className="flex items-center justify-center rounded bg-neutral-100 p-2">
                        //     <div className="text-center text-xs font-normal text-stone-500">{skill}</div>
                        // </div>
                    ))}
                </div>
                {/* Job Details */}
                <div className="flex w-full basis-2/3 flex-col items-start justify-start gap-4 px-5">
                    ...
                    <div className="flex flex-wrap items-center justify-start gap-3">
                        <div className="flex flex-col items-start justify-start gap-1">
                            ...
                            <div className="text-xs font-normal text-black">Weekly {days()}</div>
                        </div>
                        <div className="h-7 w-px bg-zinc-100" />
                        <div className="flex flex-col items-start justify-start gap-1">
                ...
                {/* Job Card Footer */}
                <div className="flex w-full items-center justify-between rounded-bl-lg rounded-br-lg bg-neutral-100 px-5 py-3">
                    ...
                    <div className="flex h-4 items-center justify-start gap-1">
                        <BookmarkIcon className="h-5 w-5 text-gray-600" aria-hidden="true" />
                        <div className="text-xs font-normal text-stone-500">Save Job</div>
                    </div>
                </div>
            </div>
        </li>
