  ...
  return (
    <div className="grid grid-cols-1 gap-x-8 gap-y-8 pt-10 md:grid-cols-3">
      <div className="px-4 sm:px-0">
        ...
        <p className="mt-1 text-sm leading-6 text-zinc-600">Specify the type of job you are looking to fill.</p>
      </div>
                    ...
                    <RadioGroup.Option
                      ...
                      {({ active, checked }) => (
                        <>
                          ...
                          <FaCheckCircle
                            className={classNames(!checked ? 'h-5 w-5 text-zinc-200' : '', 'h-5 w-5 text-green-600')}
                            aria-hidden="true"
                          />
                          <span
