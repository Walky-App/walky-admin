...
const Engagement = () => {
  ...
  return (
    <div style={{ padding: '2rem', background: 'transparent' }}>
      {/* Page Header */}
      <div className="mb-4">
        <h2 style={{ fontWeight: '700', marginBottom: '0.5rem' }}>Engagement Dashboard</h2>
        ...
        <CCol lg={4}>
          <ProgressCard
            ...
            items={[
              ...
              { label: 'Collaborated', value: ideas.collaborated, color: '#5E5CE6' },
            ]}
          />
        </CCol>
      </CRow>
      ...
      <CRow className="g-3">
        ...
        <CCol xs={6} md={3}>
          ...
          >
            ...
            <h3 style={{ fontWeight: '700', color: '#FF9500' }}>{ideas.collaborated}</h3>
          </CCard>
        </CCol>
      </CRow>
    </div>
