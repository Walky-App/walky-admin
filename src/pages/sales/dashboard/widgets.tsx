  ...
  return (
    <div className="mx-0 mb-4 sm:ml-4 xl:mr-4">
      <div className="w-full bg-zinc-50 shadow-lg rounded-2xl">
        <p className="p-4 font-bold text-zinc-950 text-md">My Jobs</p>
        <ul>
            ...
            <div className="-mx-2">
              <table className="w-full">
                ...
                <tr className="text-zinc-400">
                  ...
                  <td className="px-2 py-3 text-center text-zinc-800 cursor-pointer md:px-3 hover:text-blue-500">1</td>
                </tr>
                <tr>
