        ...
        <>
            ...
            <div className="flex gap-2 mt-3">
                {tags.map((chips, index) => (
                    <Chip key={index} onClose={() => handleClose(chips)} variant="bordered" classNames={{
                        base: "rounded-xl border-0 ring-2 ring-inset ring-green-600",
                        content: "text-black",
                        closeButton: "z-0 appearance-none outline-none select-none transition-opacity opacity-70 hover:opacity-100 cursor-pointer active:opacity-disabled tap-highlight-transparent text-large"
                    }}>
