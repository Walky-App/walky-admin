                    ...
                    <div className=" pb-12">
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-2">
                                    <SelectedOption classStyle="w-full sm:max-w-md" selectedOptions={categories} setSelectedOptions={setCategory} />
                                </div>
                            </div>
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-2">
                                    <SelectedOption classStyle="w-full sm:max-w-md" selectedOptions={levelOptions} setSelectedOptions={setLevel} />
                                </div>
                            </div>
