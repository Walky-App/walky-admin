                ...
                <div className="col-span-full">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      className="block w-full rounded-md border-0 py-1.5 pl-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:outline-none focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    />
                  </div>
                </div>
                    ...
                    <div className="relative flex gap-x-3">
                      <div className="flex h-6 items-center">
                        <input
                          ...
                          type="checkbox"
                          disabled
                          className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:outline-none focus:ring-indigo-600"
                        />
                      </div>
            ...
            {updateSuccess && (
              <div className="rounded-md bg-indigo-50 p-4">
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm font-medium text-indigo-800">Facility successfully updated</p>
                  </div>
