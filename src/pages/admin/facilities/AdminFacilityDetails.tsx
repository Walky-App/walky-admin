...
export default function AdminFacilityDetails() {
    ...
    const [updateSuccess, setUpdateSuccess] = React.useState<boolean>(false); // Added state for update success
    ...
    const handleForm = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_PUBLIC_API}/facilities/${facilityId}`, {
                method: 'PATCH',
                headers: {
            ...
            if (response.ok) {
                ...
                console.error("Error updating facility data");
