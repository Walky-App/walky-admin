        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
          <div>
            ...
            <p className="mt-1 text-sm leading-6 text-gray-600">
              Add an employee to the DNR list. This is a blacklist for people who you wouldn't want to apply for jobs of
              this particular facility. Select a person from the dropdown component and click button to add to the
              table.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 pb-12 md:grid-cols-1">
          <div>
            ...
            <DataTable
              ...
              <Column field="holiday_name" header="Avatar" />
