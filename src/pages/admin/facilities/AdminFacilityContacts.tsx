...
export default function AdminFacilityContacts() {
    ...
    const handleForm = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        //updating a facility contact selected by clicking edit button

        // fetch(`${process.env.REACT_APP_PUBLIC_API}/facilities/${facilityId}/contacts/${contactId}`, {
        //     method: 'PATCH',
        //     headers: {
        ...
        //adding the new contact to the facility contacts
        fetch(`${process.env.REACT_APP_PUBLIC_API}/facilities/${facilityId}/contacts`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                // Authorization: `Bearer ${user?.access_token}`,
            ...
            <div className="sm:flex sm:items-center">
                <div className="sm:flex-auto">
                    ...
                    <p className="mt-2 text-sm text-gray-700">
                        A list of all the contacts of the selected facility including owner, AP, Onsite.
                    </p>
                </div>
            </div>
                    ...
                    {facilityContacts && facilityContacts.length > 0 ? (
                        <table className="min-w-full divide-y divide-gray-300">
                            ...
                            <tbody className="divide-y divide-gray-200">
                                {facilityContacts.map((contact: any) => (
                                    <tr key={contact.email}>
                                        ...
                                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{contact.phone_number}</td>
                                        <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                                            <a href="#" className="text-indigo-600 hover:text-indigo-900">
                                                Edit<span className="sr-only">, {contact.first_name} {contact.last_name}</span>
                                            </a>
                                        </td>
                                    </tr>
                                ))}
                                ...
                                {updateSuccess && (
                                    <div className="rounded-md bg-green-50 p-4">
                                        <div className="flex">
                                            ...
                                            <div className="ml-3">
                                                <p className="text-sm font-medium text-green-800">Contact successfully updated</p>
                                            </div>
