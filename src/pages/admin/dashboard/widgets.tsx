  ...
  return (
    <>
      <div className="mx-0 mb-4 sm:ml-4 xl:mr-4">
        <div className="w-full rounded-2xl bg-zinc-50 shadow-lg">
          <p className="text-md p-4 font-bold text-zinc-950">My Jobs</p>
          <ul>
            <li className="flex items-center justify-between border-b-2 border-zinc-100 py-3 text-zinc-600">
              <div className="flex items-center justify-start text-sm">
                <span className="mx-4">12/03</span>
                <span>Preston Farms: Trimming</span>
              </div>
              <svg width="20" height="20" fill="currentColor" className="mx-4 text-zinc-400" viewBox="0 0 1024 1024">
                <path
            ...
            <li className="flex items-center justify-between border-b-2 border-zinc-100 py-3 text-zinc-600">
              <div className="flex items-center justify-start text-sm">
                ...
                <span className="ml-2 flex items-center text-zinc-400 lg:ml-6">
                  3
            ...
            <li className="flex items-center justify-between border-b-2 border-zinc-100 py-3 text-zinc-400">
              <div className="flex items-center justify-start text-sm">
    ...
    <div className="mb-4 sm:ml-4 xl:mr-4">
      <div className="w-full rounded-2xl bg-zinc-50 shadow-lg">
        <div className="flex items-center justify-between p-4">
          <p className="text-md font-bold text-zinc-950">Learn</p>
          <button className="mr-4 rounded border border-zinc-400 p-1 text-sm text-zinc-400">
        ...
        <div className="flex items-center justify-between border-l-4 border-blue-500 bg-blue-100 px-4 py-2 text-zinc-600">
          ...
          <div className="flex items-center">
            ...
            <button className="mr-4 rounded border bg-blue-500 p-1 text-sm text-zinc-400">
              <svg width="17" height="17" fill="currentColor" viewBox="0 0 24 24" className="text-zinc-50">
                <g fill="none">
                  <path
        ...
        <div className="flex items-center justify-between border-b-2 border-zinc-100 px-4 py-2 text-zinc-600">
          <p className="flex items-center text-xs">
...
export function CalendarWidget() {
  return (
    <div className="mb-4">
      <div className="rounded-2xl bg-zinc-50 p-4 shadow-lg">
        <div className="flex flex-wrap overflow-hidden">
          <div className="w-full rounded shadow-sm">
            <div className="mb-4 flex items-center justify-between">
              <div className="text-left text-xl font-bold text-zinc-950">Dec 2023</div>
              <div className="flex space-x-4">
                <button className="rounded-full bg-blue-500 p-2 text-zinc-50">
            ...
            <div className="-mx-2">
              <table className="w-full">
                ...
                <tr className="text-zinc-400">
                  ...
                  <td className="cursor-pointer px-2 py-3 text-center text-zinc-800 hover:text-blue-500 md:px-3">1</td>
                </tr>
                <tr>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">2</td>
                  ...
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">4</td>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">5</td>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">6</td>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">7</td>
                ...
                <tr>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">9</td>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">10</td>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">11</td>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">12</td>
                  <td className="cursor-pointer px-2 py-3 text-center text-zinc-50 md:px-3">
                    <span className="rounded-full bg-blue-500 p-2">13</span>
                  </td>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">14</td>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">15</td>
                </tr>
                <tr>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">16</td>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">17</td>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">18</td>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">19</td>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">20</td>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">21</td>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">22</td>
                </tr>
                <tr>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">23</td>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">24</td>
                  ...
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">26</td>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">27</td>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">28</td>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">29</td>
                </tr>
                <tr>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">30</td>
                  <td className="cursor-pointer px-2 py-3 text-center hover:text-blue-500 md:px-3">31</td>
                  <td></td>
                  <td></td>
                  <td></td>
                  <td></td>
...
export function MessagesWidget() {
  return (
    <div className="mb-4">
      <div className="w-full rounded-2xl bg-zinc-50 p-4 shadow-lg">
        <p className="text-md font-bold text-zinc-950">Messages</p>
        <ul>
          <li className="my-6 flex items-center space-x-2">
            ...
            <div className="flex flex-col">
              ...
              <span className="ml-2 text-sm text-zinc-400">Hey John ! Do you read the NextJS doc ?</span>
            </div>
          </li>
          <li className="my-6 flex items-center space-x-2">
            <a href="#" className="relative block">
          ...
          <li className="my-6 flex items-center space-x-2">
            ...
            <div className="flex flex-col">
              ...
              <span className="ml-2 text-sm text-zinc-400">Seriously ? haha Bob is not a child !</span>
            </div>
          </li>
          <li className="my-6 flex items-center space-x-2">
            <a href="#" className="relative block">
