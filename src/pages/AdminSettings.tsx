...
const AdminSettings = () => {
  ...
  return (
    <div style={{ padding: '2rem' }}>
        ...
        <CCardBody>
          <CTabContent>
            ...
            <CTabPane visible={activeTab === 'profile'}>
              ...
              <CRow className="mb-4">
                <CCol xs={12}>
                  ...
                  <div className="mb-3">
                    <strong>Role:</strong>{' '}
                    <CBadge color="primary">{profile?.role.toUpperCase()}</CBadge>
                  </div>
                  <div className="mb-3">
              ...
              <div className="mt-4">
                <CButton color="primary" onClick={handleUpdateProfile} disabled={saving}>
            ...
            <CTabPane visible={activeTab === 'security'}>
              ...
              {/* Change Password */}
              <div className="mb-5">
                <h6 style={{ fontWeight: '600', marginBottom: '1rem' }}>Change Password</h6>
                <CRow className="g-3">
                  <CCol xs={12}>
                ...
                <div className="mt-3">
                  <CButton color="primary" onClick={handleChangePassword} disabled={saving}>
                    {saving ? <CSpinner size="sm" className="me-2" /> : null}
                    Change Password
                  </CButton>
                </div>
              ...
              {/* Logout All Devices */}
              <div>
                <h6 style={{ fontWeight: '600', marginBottom: '1rem' }}>Active Sessions</h6>
                <div className="d-flex justify-content-between align-items-center p-3 border rounded">
                  <div>
            ...
            <CTabPane visible={activeTab === 'notifications'}>
              ...
              <div className="mb-4">
                <div className="d-flex justify-content-between align-items-center p-3 border rounded mb-3">
                  <div>
                    ...
                    <div style={{ fontSize: '0.875rem', color: '#6B7280', marginTop: '4px' }}>
                      Receive email updates about important events and activities
                    </div>
                  </div>
                  <CFormSwitch
              ...
              <div className="mt-4">
                <CButton color="primary" onClick={handleUpdateNotifications} disabled={saving}>
                  {saving ? <CSpinner size="sm" className="me-2" /> : null}
                  Save Preferences
                </CButton>
              </div>
            ...
            <CTabPane visible={activeTab === 'danger'}>
              <h5 className="mb-4" style={{ fontWeight: '600', color: '#FF3B30' }}>
                Danger Zone
              </h5>

              <CAlert color="danger">
                <strong>Warning:</strong> These actions are irreversible. Please proceed with
                caution.
              </CAlert>
      ...
      <CModal visible={showLogoutAllModal} onClose={() => setShowLogoutAllModal(false)}>
        <CModalHeader>
          <CModalTitle>Logout All Devices</CModalTitle>
        </CModalHeader>
        <CModalBody>
          <p>
            Are you sure you want to logout of all devices? You will remain logged in on this
            device, but all other active sessions will be terminated.
          </p>
        </CModalBody>
        <CModalFooter>
          <CButton color="secondary" onClick={() => setShowLogoutAllModal(false)}>
            Cancel
          </CButton>
          <CButton color="danger" onClick={handleLogoutAllDevices} disabled={saving}>
            {saving ? <CSpinner size="sm" className="me-2" /> : null}
            Logout All Devices
          </CButton>
        </CModalFooter>
      ...
      <CModal visible={showDeleteAccountModal} onClose={() => setShowDeleteAccountModal(false)}>
        <CModalHeader>
        ...
        <CModalBody>
          ...
          <p>
            Deleting your account will permanently remove all your data and revoke your
            administrator access. This action is irreversible.
          </p>
          <p>
        ...
        <CModalFooter>
          <CButton color="secondary" onClick={() => setShowDeleteAccountModal(false)}>
            Cancel
          </CButton>
          <CButton
            color="danger"
