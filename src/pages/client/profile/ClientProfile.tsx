...
export default function ClientProfile({ userId }: { userId: string }) {
  ...
  const handleInputChange = (e: any) => {
    ...
    setFormClient((prevFormClient: any) => ({
      ...prevFormClient,
      [name]: inputValue,
    }));
  };
  ...
  const handleUpdate = async (e: any) => {
    e.preventDefault();
    try {
      const res = await RequestService(`users/${userId}`, 'PATCH', formClient);
      setFormClient(res);
  ...
  return (
    <>
      <div className="border-b border-gray-200 pb-5 w-full mb-12 ">
        <h3 className="text-base font-semibold leading-6 text-gray-900">{formClient.first_name}'s profile</h3>
      </div>
      ...
      <form onSubmit={handleUpdate}>
                ...
                <div className="mt-6 space-y-6">
                  <div className="relative flex gap-x-3">
                    <div className="flex h-6 items-center">
                      <input
                        checked={formClient.notifications?.includes('notification_email')}
                        onChange={handleInputChange}
                  ...
                  <div className="relative flex gap-x-3">
                    <div className="flex h-6 items-center">
                      <input
                        checked={formClient.notifications?.includes('notification_sms')}
                        onChange={handleInputChange}
                        id="notification_sms"
        ...
        {updateSuccess && (
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm font-medium text-green-800">Successfully updated {formClient.first_name}'s profile</p>
            </div>
