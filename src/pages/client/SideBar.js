...
export default function SideBar() {
  ...
  const links = {
    ...
    client: [
      ...
      { id: 5, name: "Timesheets", href: "/dashboard/timesheets", icon: <BsFillFileEarmarkSpreadsheetFill /> },
      { id: 6, name: "Reports", href: "/dashboard/reports", icon: <HiDocumentReport /> },
      { id: 7, name: "Messages", href: "/dashboard/messages", icon: <IoMdMail/> },
      // { id: 8, name: "Facilities", href: `facilities/company/${_id}`, icon: <FaBusinessTime/> },
      { id: 9, name: "All Facilities", href: `facilities/`, icon: <FaBusinessTime/> },
      { id: 99, name: "Logout", href: "/logout", icon: <MdLogout/> },
    ],
  }
  return (
